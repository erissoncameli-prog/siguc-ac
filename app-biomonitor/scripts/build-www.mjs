...
for (const f of ['config.js', 'foto-otimizar.js', 'fotos-privadas.js', 'avatar-foto.js', 'pin-baralho.js', 'luz-nav.js', 'lgpd.js', 'lgpd-campo.js', 'qrcode-generator.js', 'guia-app.js', 'biomonitor-guias.js', 'biomonitor-offline.js', 'biomonitor-sync.js', 'biomonitor-alertas.js', 'brigada-captura.js', 'biomonitor-timeline.js', 'biomonitor-pdf-fonts.js', 'relatorio-cabecalho-pdf.js', 'biomonitor-relatorio-ninho.js', 'compartilhar-arquivo.js', 'biomonitor-relatorio-campo.js', 'biomonitor-equipamentos.js', 'etiqueta-termica.js', 'biomonitor-etiqueta.js', 'biomonitor-quelonios.js']) {
  copiarJsTranspilado(join(RAIZ, 'js', f), join(WWW, 'js', f))
}
// js/vendor/jspdf — carregado sob demanda por etqCarregarJsPDF()
// (js/etiqueta-termica.js) só quando uma etiqueta de ninho/berçário/
// lote é exportada em PDF. Mesmo motivo e mesma trava de caminho
// relativo do app-agua/scripts/build-www.mjs (RFC 3986 colapsa o
// '../' excedente mesmo com index.html na raiz do app nativo).
copiarJsTranspilado(join(RAIZ, 'js/vendor/jspdf-2.5.2.umd.min.js'), join(WWW, 'js/vendor/jspdf-2.5.2.umd.min.js'))
