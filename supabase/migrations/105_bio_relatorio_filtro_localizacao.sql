-- ═══════════════════════════════════════════════════════════
-- SIGUC-AC · Biomonitor — Filtro de localização no relatório
-- ───────────────────────────────────────────────────────────
-- Acrescenta o parâmetro opcional p_tipo_localizacao à RPC
-- bio_relatorio_completo, permitindo filtrar o relatório por
-- tipo de localização da praia (dentro de UC, margem livre,
-- terra indígena, área municipal, outro) — usado pelo
-- pré-filtro "Localização" da página de relatórios, que só
-- exibe o seletor de UC quando "Dentro de UC" é escolhido.
-- ═══════════════════════════════════════════════════════════

DROP FUNCTION IF EXISTS bio_relatorio_completo(uuid, uuid, uuid, uuid);

CREATE FUNCTION bio_relatorio_completo(
...
GRANT EXECUTE ON FUNCTION bio_relatorio_completo(uuid, uuid, uuid, uuid, tipo_localizacao_praia) TO authenticated;
