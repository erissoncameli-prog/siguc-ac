-- ═══════════════════════════════════════════════════════════════
-- SIGUC-AC · Biomonitor — nome do rio na praia
-- Adiciona praias_monitoramento.rio (texto livre) e repõe o campo
-- na vw_praias_biomonitor (fiel à definição de 127, só acrescenta rio).
-- ═══════════════════════════════════════════════════════════════

ALTER TABLE praias_monitoramento ADD COLUMN rio text;
