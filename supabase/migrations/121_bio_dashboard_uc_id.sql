-- ═══════════════════════════════════════════════════════════
-- SIGUC-AC · Biomonitor — bio_dashboard_praias expõe uc_id
-- ───────────────────────────────────────────────────────────
-- Adiciona uc_id ao JSON de cada praia para que a UI monte o
-- filtro de UC (id + nome) a partir do próprio resultado do
-- dashboard, sem depender de outra fonte. Recria a função
-- (idêntica à 118) apenas acrescentando uc_id ao objeto.
-- Depende de 118.
-- ═══════════════════════════════════════════════════════════
