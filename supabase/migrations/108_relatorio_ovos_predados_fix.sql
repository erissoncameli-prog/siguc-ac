-- ═══════════════════════════════════════════════════════════════
-- SIGUC-AC · Biomonitor — Fix: predação de ovos na assinatura correta
-- ───────────────────────────────────────────────────────────────
-- A 107 redefiniu a assinatura de 4 args de bio_relatorio_completo,
-- mas a usada pelo frontend tem 5 args (p_tipo_localizacao). Aqui:
--   · remove o overload de 4 args (órfão da 107);
--   · adiciona total_ovos_predados / total_ovos_viaveis na função de
--     5 args (a real). Depende de 093/105.
-- ═══════════════════════════════════════════════════════════════

DROP FUNCTION IF EXISTS public.bio_relatorio_completo(uuid, uuid, uuid, uuid);
