-- ═══════════════════════════════════════════════════════════════
-- SIGUC-AC · Biomonitor — Predação de ovos nas estatísticas do relatório
-- ───────────────────────────────────────────────────────────────
-- bio_relatorio_completo passa a expor:
--   total_ovos_predados = soma dos descartes por predação (inclui a
--                         predação lançada nas visitas, via 105)
--   total_ovos_viaveis  = postura − todos os descartes
-- Mantém qtd_ovos (postura) como histórico. Depende de 091/093/105.
-- ═══════════════════════════════════════════════════════════════
  ...
  SELECT jsonb_build_object(
    ...
    'kpis', (
      SELECT jsonb_build_object(
        ...
        'total_ovos_predados',   a.total_ovos_predados,
        'total_ovos_viaveis',    a.total_ovos_viaveis,
