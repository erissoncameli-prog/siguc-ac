-- ═══════════════════════════════════════════════════════════
-- SIGUC-AC · Migration 031 — Segurança do Portal de Pesquisa
-- Registro de aceite da IN SEMAPI Nº 1/2021 no momento da
-- submissão pública. Campo de auditoria para rastreabilidade.
-- ═══════════════════════════════════════════════════════════

ALTER TABLE pesquisas
  ADD COLUMN IF NOT EXISTS aceite_in_em timestamptz;

-- ── Atualiza submeter_pesquisa_publica com novo campo ─────────
