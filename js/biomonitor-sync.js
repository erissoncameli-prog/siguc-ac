...
async function bioSyncNinhos(monitorId, onProgresso) {
  ...
  for (const ninho of pendentes) {
    ...
    const payload = {
      ...
      contagem_ovos_metodo:       ninho.contagem_ovos_metodo       || 'contado',
      qtd_ovos_estimado_original: ninho.qtd_ovos_estimado_original ?? null,
...
async function bioSyncTransferencias(monitorId, onProgresso) {
  ...
  for (const t of pendentes) {
    ...
    const payload = {
      ...
      qtd_ovos:            t.qtd_ovos,
      postura_corrigida:   t.postura_corrigida ?? null,
...
async function bioSyncEclosoes(monitorId, onProgresso) {
  ...
  for (const e of pendentes) {
    ...
    const payload = {
      ...
      predacao:           e.predacao,
      postura_corrigida:  e.postura_corrigida ?? null,
      foto_urls:          fotoUrls,
