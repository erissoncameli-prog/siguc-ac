...
function gerarLayout(tituloPagina, paginaAtiva) {
  ...
  const iconePills = {
    ...
    'painel-fogo-desmatamento': { svg: '<path d="M3 3v18h18"/><path d="M7 15l4-5 3 3 5-6"/><path d="M17 7h2v2"/>', cor: '#fdba74', bg: 'rgba(253,186,116,0.22)' },
    ...
    'biomonitor-transferencias':{ svg: '<path d="M4 7h13"/><path d="m13 3 4 4-4 4"/><path d="M20 17H7"/><path d="m11 21-4-4 4-4"/>', cor: '#8b5cf6', bg: 'rgba(139,92,246,0.18)' },
  ...
  const navGroups = [
    ...
    },
    {
      ...
      itens: [
        ...
        { id: 'painel-fogo-desmatamento', href: '../pages/painel-fogo-desmatamento.html', label: 'Painel de Fogo e Desmatamento' },
    ...
    },
    {
      ...
      itens: [
        ...
        { id: 'biomonitor-transferencias', href: '../pages/biomonitor-transferencias.html', label: 'Transferência em lote',
          perfis: ['gestor','tecnico','super_admin'] },
